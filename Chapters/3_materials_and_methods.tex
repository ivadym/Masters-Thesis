...
\begin{figure}[ht]
    ...
    \caption{Ion Torrent NGS template preparation. Modified image from \cite{NGS}.}
    \label{fig:ePCR}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Ion Torrent NGS sequencing: measurement of nucleotide addition. Modified image from \cite{NGS}.}
