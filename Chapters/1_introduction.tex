...
\rowcolor[HTML]{FFFFFF} 
    \multicolumn{2}{l}{\cellcolor[HTML]{FFFFFF}\textbf{M1}} & Distant metastasis \\
        ...
        \rowcolor[HTML]{FFFFFF} & \textbf{M1c} & Multiple extrathoracic metastases in a single organ or in multiple organs
\end{tabular}}
\caption{M-descriptors of TNM classification for lung cancer \cite{TNM_proposal}.}
...
\end{tabular}}
\caption{Overview driver genetic alterations potentially amenable to targeted treatment \cite{EGFR_mutations, EML4_ALK, KRAS_drugs, BRAF, ROS1, RET, MET, HER2, NSCLC_therapies}}.
...
\end{tabular}}
\caption{ALK inhibitors and main clinical trials \cite{ALK_res_mutations}.}
