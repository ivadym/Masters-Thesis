...
\cellcolor[HTML]{EFEFEF} & Male & 13 & 43.3 \% \\
\rowcolor[HTML]{EFEFEF}
\multirow{-2}{*}{\cellcolor[HTML]{EFEFEF}\textbf{Sex}} & Female & 17 & 56.7 \% \\
\rowcolor[HTML]{FFFFFF}
\cellcolor[HTML]{FFFFFF} & Current smokers & 4 & 13.3 \% \\
\rowcolor[HTML]{FFFFFF}
\cellcolor[HTML]{FFFFFF} & Ex-smokers & 8 & 26.7 \% \\
\rowcolor[HTML]{FFFFFF}
\multirow{-3}{*}{\cellcolor[HTML]{FFFFFF}\textbf{Smoking status}} & Never smokers & 18 & 60 \% \\
\rowcolor[HTML]{EFEFEF}
...
\rowcolor[HTML]{EFEFEF} 
\cellcolor[HTML]{EFEFEF} & II & 1 & 3.3 \% \\
\rowcolor[HTML]{EFEFEF}
\cellcolor[HTML]{EFEFEF} & III & 6 & 20 \% \\
\rowcolor[HTML]{EFEFEF}
\multirow{-3}{*}{\cellcolor[HTML]{EFEFEF}\textbf{\begin{tabular}[c]{@{}c@{}}Initial\\ clinical stage\end{tabular}}}  & IV & 23 & 76.7 \% \\
\rowcolor[HTML]{FFFFFF}
